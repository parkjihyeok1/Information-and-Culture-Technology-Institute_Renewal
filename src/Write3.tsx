...
class Write3 extends Component<IProps, IState> {
  ...
  write = () => {
    ...
    Axios.post("https://220.149.236.48:3306/insert3", formData)
      .then((res) => {
  ...
  update = () => {
    ...
    Axios.post("https://220.149.236.48:3306/update3", formData)
      .then((res) => {
  ...
  detail = () => {
    Axios.post("https://220.149.236.48:3306/detail3", {
      id: this.props.boardId,
    })
      .then((res) => {
        if (res.data) {
          this.setState({
            title: res.data.BOARD_TITLE3,
            content: res.data.BOARD_CONTENT3,
            isRendered: true,
          });
        }
      })
