...
class Write5 extends Component<IProps, IState> {
  ...
  write = () => {
    ...
    Axios.post("https://220.149.236.48:3306/insert5", formData)
      .then((res) => {
  ...
  update = () => {
    ...
    Axios.post("https://220.149.236.48:3306/update5", formData)
      .then((res) => {
  ...
  detail = () => {
    Axios.post("https://220.149.236.48:3306/detail5", {
      id: this.props.boardId,
    })
      .then((res) => {
        if (res.data) {
          this.setState({
            title: res.data.BOARD_TITLE5,
            content: res.data.BOARD_CONTENT5,
            isRendered: true,
          });
        }
      })
