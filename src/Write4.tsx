...
class Write4 extends Component<IProps, IState> {
  ...
  write = () => {
    ...
    Axios.post("http://localhost:8000/insert4", formData)
      .then((res) => {
  ...
  update = () => {
    ...
    Axios.post("http://localhost:8000/update4", formData)
      .then((res) => {
  ...
  detail = () => {
    Axios.post("http://localhost:8000/detail4", {
